StringTable tutorialStrings
{
	...
	[
		...
		{ String _name = "Step_FirstHouse_01_Pre";	String _text = "คุณคงจะสังเกตเห็นว่าชาวเมืองบางคนมีไอคอนนี้อยู่เหนือศีรษะพวกเขา"; } 
		...
		{ String _name = "Step_FirstHouse_3_Pre";	String _text = "เลื่อนเมาส์ของคุณไปยังบริเวณที่เน้นสีไว้และกดเมาส์ปุ่มซ้าย"; } 
		...
		{ String _name = "Step_MoreHouses_2_Pre";	String _text = "เลื่อนเมาส์ของคุณไปยังบริเวณที่เน้นสีไว้และกดเมาส์ปุ่มซ้าย คุณอาจจะต้องหมุนโครงสร้างบ้านเพื่อให้มันพอดีกับพื้นที่ที่แสดงไว้ คุณสามารถหมุนสิ่งก่อสร้างโดยการกดปุ่ม"; } 
		...
		{ String _name = "Step_Fish_51_Pre";		String _text = "คุณคงจะสังเกตเห็นว่าชาวเมืองบางคนมีไอคอนนี้อยู่เหนือศีรษะพวกเขา"; } 
